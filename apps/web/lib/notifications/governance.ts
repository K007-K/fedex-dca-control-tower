...
export const GOVERNED_NOTIFICATIONS: Record<string, NotificationConfig> = {
    ...
    'escalations': {
        ...
        tier: 'CRITICAL',
        isNonDisableable: true,
        eligibleRoles: ['SUPER_ADMIN', 'FEDEX_ADMIN', 'FEDEX_MANAGER', 'DCA_ADMIN', 'DCA_AGENT'],
        defaultEmail: true,
        defaultInApp: true,
        category: 'SYSTEM',
    },
    ...
    'case_updates': {
        ...
        eligibleRoles: ['SUPER_ADMIN', 'FEDEX_ADMIN', 'FEDEX_MANAGER', 'FEDEX_ANALYST', 'DCA_ADMIN', 'DCA_AGENT'],
        defaultEmail: true,
        defaultInApp: true,
        category: 'CASE',
    },
    'case_assignments': {
        ...
        tier: 'OPERATIONAL',
        isNonDisableable: false,
        eligibleRoles: ['FEDEX_MANAGER', 'DCA_ADMIN', 'DCA_AGENT'],
        defaultEmail: true,
        defaultInApp: true,
        category: 'CASE',
    },
    ...
    'dca_performance': {
        ...
        tier: 'OPERATIONAL',
        isNonDisableable: false,
        eligibleRoles: ['SUPER_ADMIN', 'FEDEX_ADMIN', 'FEDEX_MANAGER', 'DCA_ADMIN'],
        defaultEmail: false,
        defaultInApp: true,
        category: 'DCA',
    },
    ...
    'weekly_summaries': {
        ...
        tier: 'INFORMATIONAL',
        isNonDisableable: false,
        eligibleRoles: ['SUPER_ADMIN', 'FEDEX_ADMIN', 'FEDEX_MANAGER', 'FEDEX_ANALYST', 'DCA_ADMIN'],
        defaultEmail: false,
        defaultInApp: true,
        category: 'PLATFORM',
    },
